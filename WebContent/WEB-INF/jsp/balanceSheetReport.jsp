...
<body>
<%
String filename =  "/WEB-INF/reports/BalanceSheet.jasper";
String reporttype =  "pdf";
String Paramtype =  "";
//Object stockAmount = request.getAttribute("stockAmount");
...
//jasperParameter.put("stockAmount", stockAmount);
...
response.setHeader("Content-Disposition",  "inline; filename=\"BalanceSheet.rtf\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"BalanceSheet.html\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"BalanceSheet.xls\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"BalanceSheet.csv\"");
