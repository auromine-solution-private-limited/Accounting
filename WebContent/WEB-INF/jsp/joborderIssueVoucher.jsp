...
*/
String filename =  "/WEB-INF/reports/JoborderIssueVoucher.jasper";
...
response.setHeader("Content-Disposition",  "inline; filename=\"IssueVoucher.pdf\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"IssueVoucher.rtf\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"IssueVoucher.html\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"IssueVoucher.xls\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"IssueVoucher.csv\"");
