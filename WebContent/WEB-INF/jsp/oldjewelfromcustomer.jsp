...
String jewelrepaiId=request.getParameter("jewelrepaiId");
...
*/
String filename =  "/WEB-INF/reports/oldjewelFromCustomer.jasper";
...
jasperParameter.put("jewelrepaiId",jewelrepaiId);
