...
<script language="javascript" type="text/javascript" > 
	$(document).ready(function(){
		...
		$(".list_table2").advancedtable({searchField: "#listsearch2", loadElement: "#loader", searchCaseSensitive: false, ascImage: "images/up.png", descImage: "images/down.png"});
		$("#search2").show();
						...
						$.ajax({
							...
							success : function(data){
								...
								if(metal_type == "Gold Ornaments" || metal_type =="Gold Loose Stock" ){
									window.location.href = 'formjeweltype.htm';
								}
        ...
        <b class="Popup_heading">New Category Form</b>
         <div class="content">
			...
			<tr>
				...
				<td>
				<select name="metalType" id="metal_type" class="noEnterSubmit">
				...
				<td>
					<input name="jewelName" id="jewel_Name" maxlength="15" class="nameCapitalize noEnterSubmit"/>
				</td>
			</tr>
			<tr>
			<td  bgcolor="#BBDDFF" width="180">Base Metal Used</td>
			<td>			
			<input name="metalUsed" id="base_metal" onchange="metal();" readonly="readonly" class="noEnterSubmit"/>
			</td>
...
%>
	...
	<br>
		<div class="summary">Category List<br><input name="search" type="text" id="listsearch2" style="float: left;"  /></div>
		<div id="goldsiltab">
			<ul>
				<li><a class="TabClass" href="formjeweltype.htm">Gold</a></li>
				<li><a class="TabClass activetabs" href="listCategorySilver.htm">Silver</a></li>
			</ul>
		<div id="silvert" class="catTabclass"  style ="width:763px; padding-bottom:10px;">
			...
			<c:forEach var="jeweltype" items="${jewelTypeListsilver}">
			
			<c:if test='${jeweltype.jewelTypeId > 10}'>
			<tr>
			<!-- <td>${jeweltype.jewelTypeId}</td> -->
			<td class="s_no_sil"></td>
