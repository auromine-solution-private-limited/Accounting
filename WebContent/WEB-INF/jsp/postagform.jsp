...
<div id="col-form" align="left">
	...
	<input name="search" type="text" id="listsearch" style="float: left;" /><input name="search" type="hidden" id="listsearch2" style="float: left;"  />
	...
	<div id="printedtab">
			...
			<!--  	<li class="linkss" >< a  class="TabClass"  href="POSPrintedList.htm" id="Printed" title="PrintTagged">Printed</a></li>-->
					<li class="linkss" ><a  class="TabClass" href="POSPrintedList.htm">Printed</a></li>
					<li class="linkss" ><a class="TabClass activetabs" href="postagitem.htm" >Unprinted</a></li>
			...
			<div id="Printed" class="catTabclass posBarCheckList"  style="width:763px;">
		...
		<c:forEach var="posList" items="${positemlist}">	
				<tr bgcolor="#FFFFFF">
				<!--<td>${posList.tagId}</td>-->
