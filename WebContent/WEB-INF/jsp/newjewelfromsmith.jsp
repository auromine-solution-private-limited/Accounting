...
String smithId=request.getParameter("smithId");
...
*/
String filename =  "/WEB-INF/reports/newjewelFromSmith.jasper";
...
jasperParameter.put("smithId",smithId);
...
response.setHeader("Content-Disposition",  "inline; filename=\"newjewelbill.pdf\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"newjewelbill.rtf\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"newjewelbill.html\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"newjewelbill.xls\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"newjewelbill.csv\"");
