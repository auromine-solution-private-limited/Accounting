...
<head>
	...
	<script language="javascript" type="text/javascript" src="script/xfade2.js"></script>
...
<decorator:body />
<script type="text/javascript"  type="text/javascript" src="script/ledger_Name_Auto.js"></script>
<div id="footer">
