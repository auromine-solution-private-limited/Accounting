...
<%
String DBfrmdate =  request.getParameter("DBfrmdate");
String DBtodate =  request.getParameter("DBtodate");

String filename =  "/WEB-INF/reports/AccDetailedDayBook.jasper";
...
jasperParameter.put("FromDate",DBfrmdate);
jasperParameter.put("ToDate",DBtodate);
