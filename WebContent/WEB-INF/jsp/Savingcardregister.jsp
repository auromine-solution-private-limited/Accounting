...
String filename =  "/WEB-INF/reports/cardwiseschemeDetails.jasper";
...
//jasperParameter.put("dateOfJoining",dateOfJoining);
...
response.setHeader("Content-Disposition",  "inline; filename=\"schemewiseregister.pdf\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"schemewiseregister.rtf\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"schemewiseregister.html\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"schemewiseregister.xls\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"schemewiseregister.csv\"");
