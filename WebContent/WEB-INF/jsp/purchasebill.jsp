...
*/
String filename =  "/WEB-INF/reports/PurchaseBill.jasper";
...
jasperParameter.put("pbillNo",pbillNo);
...
response.setHeader("Content-Disposition",  "inline; filename=\"PurchaseBill.pdf\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"PurchaseBill.rtf\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"PurchaseBill.html\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"PurchaseBill.xls\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"PurchaseBill.csv\"");
