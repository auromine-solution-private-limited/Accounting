...
<a href="newCustomer.htm" class="create_or_list">Add New Customer</a> <!-- ************************ Call to URI  formcustomer.jsp page-->
<br>
<div class="summary">Debtors Account<br><input name="search" type="text" id="listsearch" style="float: left;"  /></div>
		...
		<tr>
			...
			<c:forEach var="ledger" items="${accounts.ledgers}">
				<tr bgcolor="#FFFFFF">							  
				   ...
				   <!-- *************** calls formcustomer.jsp page with attributes -->
				   <td class="s_no"></td>		
				   ...
				   <td><a href="viewCustomer.htm?ledgerId=${ledger.ledgerId}&accountId=${accounts.accountId}" class="edit">Edit</a> </td>
