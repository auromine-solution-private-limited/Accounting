...
*/
String filename =  "/WEB-INF/reports/JoborderReceiptVoucher.jasper";
...
response.setHeader("Content-Disposition",  "inline; filename=\"ReceiptVoucher.pdf\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"ReceiptVoucher.rtf\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"ReceiptVoucher.html\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"ReceiptVoucher.xls\"");
...
response.setHeader("Content-Disposition",  "inline; filename=\"ReceiptVoucher.csv\"");
